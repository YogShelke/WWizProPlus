...
*****************************************************************************/
#pragma once
#ifndef WARDWIZHASH_H
#define WARDWIZHASH_H 1
...
extern uint4		m_State[4];
extern uint4		m_Count[2];
extern uchar		m_Buffer[64];
extern uchar		m_Digest[16];
extern uchar		m_Finalized;
