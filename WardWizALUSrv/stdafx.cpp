...
// WardWizALUSrv.pch will be the pre-compiled header
...
CString GetAVPathFromRegistry( LPTSTR lpszAVPath )
{
	HKEY	hSubKey = NULL ;
	TCHAR	szModulePath[MAX_PATH] = {0};
	...
	if( lpszAVPath )
		wcscpy_s(lpszAVPath, 511, szModulePath );
