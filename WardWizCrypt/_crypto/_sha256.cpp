...
void SHA256_Init(SHA256_DATA *sha)
{
	sha->inputLen = 0;
	sha->A = 0x6a09e667;
	sha->B = 0xbb67ae85;
 ...
 */
static void ProcessBlock(SHA256_DATA *sha, const unsigned char *block)
{
	UINT32 W[64];
...
void SHA256_Data(SHA256_DATA *sha, const void *buffer, unsigned long len)
{
...
void SHA256_Finalize(SHA256_DATA *sha, unsigned char *hash)
{
	UINT64 totalBits;
	...
	memset(sha, 0, sizeof(SHA256_DATA));
}
