...
extern void _AES_Encrypt_CBC(BYTE *_buf, UINT32 _iBlockCount, DWORD *_expanded_key, BYTE *_cbc_state);
extern void _AES_Decrypt_CBC(BYTE *_buf, UINT32 _iBlockCount, DWORD *_expanded_key, BYTE *_cbc_state_prev, BYTE *_cbc_state_curr);
