/***************************************************************************                      
   Program Name          : FlatToolTipCtrl.cpp
   Description           : To customize flat tooltip control
   Author Name           :                                                                         
...
/***************************************************************************************************                    
*  Function Name  : CToolTipCtrlEx                                                     
*  Description    : C'tor
*  Author Name    : 
*  SR_NO          : WRDWIZCOMMON_0318
*  Date           : 18 Oct 2013
****************************************************************************************************/
CToolTipCtrlEx::CToolTipCtrlEx()
{
	...
	{
		AddLogEntry(_T("### Exception caught in CToolTipCtrlEx::CToolTipCtrlEx"), 0, 0, true, SECONDLEVEL);
	}
}
...
void CToolTipCtrlEx::PreSubclassWindow()
{
	...
	{
		AddLogEntry(_T("Exception caught in CToolTipCtrlEx::PreSubclassWindow"), 0, 0, true, SECONDLEVEL);
	}
}
...
void CToolTipCtrlEx::OnPaint()
{
	...
	{
		AddLogEntry(_T("Exception caught in CToolTipCtrlEx::OnPaint"), 0, 0, true, SECONDLEVEL);
	}
}
...
BOOL CToolTipCtrlEx::OnEraseBkgnd(CDC* pDC)
{
	...
	{
		AddLogEntry(_T("Exception caught in CToolTipCtrlEx::OnEraseBkgnd"), 0, 0, true, SECONDLEVEL);
	}
	return FALSE;
}
