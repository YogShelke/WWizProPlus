...
public:
	...
	// loads a picture from a program resource dll
	// i.e. Load(m_hResDLL, MAKEINTRESOURCE(IDR_MYPIC),_T("GIFTYPE"));
	BOOL Load(HMODULE hResHandle, LPCTSTR szResourceName, LPCTSTR szResourceType);
