...
//		call	GetTextBkColor()
//		or		SendMessage (PBM_GETBKCOLORNEW, 0, 0)
...
#define PBM_GETBKCOLORNEW		(WM_USER+101)
...
class CTextProgressCtrl : public CProgressCtrl
{
	...
	public:
		...
		inline COLORREF GetBarBkColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_GETBKCOLORNEW, 0, 0)); }
