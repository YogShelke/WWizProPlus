...
//SET ICMP_STATUS
typedef UNALIGNED struct _NF_SET_ICMP_STATUS
{
	BOOLEAN bRuleStatus;
} NF_SET_ICMP_STATUS, *PNF_SET_ICMP_STATUS;

typedef UNALIGNED struct _NF_SET_PORTSCAN_STATUS
{
	BOOLEAN bRuleStatus;
} NF_SET_PORTSCAN_STATUS, *PNF_SET_PORTSCAN_STATUS;
...
#define NF_REQ_SET_ICMP_RULE \
	CTL_CODE(FILE_DEVICE_UNKNOWN, 120, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define NF_REQ_SET_PORTSCAN_RULE \
	CTL_CODE(FILE_DEVICE_UNKNOWN, 121, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IO_REFERENCE_EVENT \
            _DEVCTRL_CTL_CODE(0x201, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IO_DEREFERENCE_EVENT \
            _DEVCTRL_CTL_CODE(0x202, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IO_SET_EVENT \
            _DEVCTRL_CTL_CODE(0x203, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IO_CLEAR_EVENT \
            _DEVCTRL_CTL_CODE(0x204, METHOD_NEITHER, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
