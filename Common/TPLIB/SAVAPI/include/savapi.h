 ...
 */
#define SAVAPI_API_MINOR_VERSION    4
 ...
 * \note These options are deprecated and they will be removed in a future release
 * \{
 */
...
typedef enum SAVAPI_option
{
     ...
     * \brief Activate detection for the specified type.
     * \note Default value: 0 (disabled)
     * \note This option is deprecated and it will be removed in a future release.
     */
     ...
     *       \ref SAVAPI_OPTION_APC_FILE_EXTENSIONS_CHECK_ONLY) will be reset
     ...
     * \note Maximum extension length is 255 characters (including the dot). The maximum number of extensions is 128.
     * \note This option has a higher priority and will refine SAVAPI_OPTION_APC_FILE_EXTENSIONS_POLICY option
     * \note This option depends on the global APC_MODE
     * \note Default value: none
     * Example: .exe;.xls;.bin;.doc
     */
    ...
    /** Retrieve the English description for the given type.*/
    /** This option is deprecated and it will be removed in a future release.*/
 ...
 * \note This callback is deprecated and it will be removed in a future release.
 */
...
typedef struct SAVAPI_global_init
{
    ...
    /** Full path to the license file (optional)
     * \note If this variable is set to NULL or empty string,
...
typedef struct SAVAPI_instance_init
{
    ...
    * \warning Please note that this field will be removed in a future release.
    */
 ...
 * \note This structure is deprecated and it will be removed in a future release.
 */
...
typedef void(CC *SAVAPI_set_quickload_init_t)();
typedef SAVAPI_STATUS (CC *SAVAPI_uninitialize_t)();
...
typedef SAVAPI_STATUS (CC *SAVAPI_APC_uninitialize_t)();

typedef SAVAPI_STATUS (CC *SAVAPI_OA_initialize_t)(SAVAPI_OA_GLOBAL_INIT *savapi_oa_init);
typedef SAVAPI_STATUS (CC *SAVAPI_OA_uninitialize_t)();
...
typedef SAVAPI_STATUS (CC *SAVAPI_OA_start_scan_t)();
typedef SAVAPI_STATUS (CC *SAVAPI_OA_stop_scan_t)();
 ...
 * \param user_data [IN]: The user context
 * \return SAVAPI_S_OK on success and an error otherwise
 *
 ...
 */
void SAVAPI_EXP CC SAVAPI_set_quickload_init();
 ...
 */
SAVAPI_EXP SAVAPI_STATUS CC SAVAPI_uninitialize();
 ...
 */
SAVAPI_EXP SAVAPI_STATUS CC SAVAPI_APC_uninitialize();
 ...
 */
SAVAPI_EXP SAVAPI_STATUS CC SAVAPI_is_running();
 ...
 * \note For better functionality and the possibility to load a new engine without interrupt
 *       of service, please check the \ref SAVAPI_reload_engine_ex function.
 * \note This function will return \ref SAVAPI_E_NOT_SUPPORTED in client-mode
 ...
 */
SAVAPI_EXP SAVAPI_STATUS CC SAVAPI_reload_engine();
 ...
 * \note Only supported on Windows.
*/
SAVAPI_EXP SAVAPI_STATUS CC SAVAPI_OA_uninitialize();
 ...
 * \note Only supported on Windows.
*/
SAVAPI_EXP SAVAPI_STATUS CC SAVAPI_OA_start_scan();
 ...
 * \note Only supported on Windows.
*/
SAVAPI_EXP SAVAPI_STATUS CC SAVAPI_OA_stop_scan();
