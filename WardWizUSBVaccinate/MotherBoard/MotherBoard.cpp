// MotherBoard.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CMotherBoardApp, CWinApp)
	ON_COMMAND(ID_HELP, &CMotherBoardApp::OnBnClickedButtonHelp)
END_MESSAGE_MAP()


// CMotherBoardApp construction

CMotherBoardApp::CMotherBoardApp()
{
	m_hResDLL			= NULL;
...
// The one and only CMotherBoardApp object

CMotherBoardApp theApp;


// CMotherBoardApp initialization

BOOL CMotherBoardApp::InitInstance()
{
	...
	{
		HWND hWindow = ::FindWindow(NULL, L"Vibranium USB VACCINATOR");
		if (hWindow)
		{
			::ShowWindow(hWindow, SW_RESTORE);
			::BringWindowToTop(hWindow);
			::SetForegroundWindow(hWindow);
			AddLogEntry(L"Wardwiz autorun scanner is already running.", 0, 0, true, SECONDLEVEL);
			return FALSE;
		}
		return FALSE;
	}
...
*  Date           : 18 Sep 2013
****************************************************************************************************/
CMotherBoardApp::~CMotherBoardApp(void)
{
	if (m_hResDLL != NULL)
	{
...
*  Date           : 30 Apr 2014
**********************************************************************************************************/
void CMotherBoardApp::CreateFonts()
{
...
*  Date           : 18 Sep 2013
****************************************************************************************************/
CString CMotherBoardApp::GetModuleFilePath()
{
...
*  Date           : 27 May 2014
****************************************************************************************************/
void CMotherBoardApp::LoadResourceDLL()
{
...
*  Date           : 27 May 2014
****************************************************************************************************/
void CMotherBoardApp::CreateFontsFor(DWORD OSType, DWORD LanguageType)
{
	switch (OSType)
	{
	case WINOS_95:
...
*  Date           : 05 May 2015
****************************************************************************************************/
void CMotherBoardApp::OnBnClickedButtonHelp()
{
	try
	{
		TCHAR szModulePath[MAX_PATH] = { 0 };
		...
		case ELITE:_tcscat_s(szFullPath, L"\\WrdWizElite.chm");
			break;
...
Modification   :
****************************************************************************/
void CMotherBoardApp::AddUserAndSystemInfoToLogSEH()
{
...
void CMotherBoardApp::AddUserAndSystemInfoToLog()
{
	try
	{
	...
	{
		AddLogEntry(L"### Exception in CMotherBoardApp::AddUserAndSystemInfoToLog", 0, 0, true, SECONDLEVEL);
	}
}
...
*  Date           : 12 May 2015
****************************************************************************************************/
bool CMotherBoardApp::SingleInstanceCheck()
{

	m_hMutex = CreateMutex(NULL, TRUE, L"Global\\VibraniumUSBVAC");
...
Modification   :
****************************************************************************/
bool CMotherBoardApp::CheckMutexOfDriverInstallation()
{
	try
	{
