//CWardWizSchedScanMissDlg.h : Header file for the Scan Missed Tray Pop Up
//
#pragma once
#include "stdafx.h"
#include "afxwin.h"
...
class CWardWizSchedScanMissDlg : public CDialog,
	public CSciterBase,
	public sciter::host<CWardWizSchedScanMissDlg>
{
	DECLARE_DYNAMIC(CWardWizSchedScanMissDlg)

public:
	CWardWizSchedScanMissDlg(CWnd* pParent = NULL);   // standard constructor
	virtual ~CWardWizSchedScanMissDlg();

// Dialog Data
	enum { IDD = ID_DIALOG_TRAY_SCHEDSCAN_MISS };
