...
OutputDir=.\Output
OutputBaseFilename=WardWizBasicSetupNCIx64
...
var
ParamAssign:Integer;
GetFailedMsg,GetFirstAppMsg,GetSecondAppMsg,GetProductName,GetWWiZAppPath,Gettempfolder,GetfinalCmd,GetSetupDllPath,GetCurrentFileName,GetFileNameShowForm:String;
   ...
   begin
      ...
      begin
           SetSelectedLanguage(ExpandConstant('{language}') );
			...
			begin
					Log('Inside if(CurStep = ssPostInstall) /verysilent');
          SetSelectedLanguage(ExpandConstant('{language}') ); 
					// To Get MVersion
					GetMVersion(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus');
			end;
...
begin
 ...
 // check for lower version of windows XP SP3
