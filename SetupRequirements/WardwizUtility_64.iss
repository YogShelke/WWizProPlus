...
#define SupportNumberClam ReadIni("D:\WardWizDevEPS_4.1\WWBinary.ini", "SupportNo", "SupportNumberClam", "(+91) 3952 0795")
#define SupportNumberNC ReadIni("D:\WardWizDevEPS_4.1\WWBinary.ini", "SupportNo", "SupportNumberNC", "")
...
OutputDir=D:\WardWizDevEPS_4.1\Release\x64\Binaries\
...
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyWardWizAppName}; Filename: {app}\{#MyAppExeName}; Tasks: quicklaunchicon; IconFilename: {app}\COMPANYLOGO.ICO
...
;Filename: {app}\{#MyTlbExeName}; Description: {cm:LaunchProgram,{#StringChange(MyTlbName, '&', '&&')}}; Flags: nowait
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: string; ValueName: LastLiveupdatedt; ValueData: {code:Date} {code:Time}; Flags: uninsdeletekey noerror createvalueifdoesntexist; Tasks: ; Languages: 
