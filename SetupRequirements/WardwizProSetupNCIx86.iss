...
OutputDir=.\Output
OutputBaseFilename=WardWizProSetupNCIx86
...
Source: RequiredFiles\PROTECTION\32\{#FPSCANNER}; DestDir: {app}\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: RequiredFiles\PROTECTION\32\{#PPSECURE64}; DestDir: {app}\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: RequiredFiles\PROTECTION\32\{#PPXPROC}; DestDir: {app}\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: RequiredFiles\DRIVERS\TDI\I386\WRDWIZFLT.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: RequiredFiles\DRIVERS\WFP\WINDOWS7\I386\WRDWIZFLT07.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: RequiredFiles\DRIVERS\WFP\WINDOWS8\I386\WRDWIZFLT08.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: RequiredFiles\DRIVERS\WFP\WINDOWS10\I386\WRDWIZFLT10.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
...
Source: ..\Release\Win32\Binaries\WRDWIZRKSCN.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwRelNotesShow; ValueData: 0; Flags: uninsdeletekey noerror createvalueifdoesntexist
...
begin
  ...
  begin
	//Issue: While reinstalling setup if we click install button multiple pop-up appears.
