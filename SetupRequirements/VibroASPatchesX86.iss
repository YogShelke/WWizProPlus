...
#define MyAppURL "http://www.Vibranium.com/"
...
OutputDir=.\Output
OutputBaseFilename=WardWizEssPlusPatchIx86
...
CMWWCloseAllWWApp =Please close all Vibranium running application(s) for reinstallation
english.CMWWCloseAllWWApp =Please close all Vibranium running application(s) for reinstallation
...
Source: RequiredFiles\DRIVERS\WFP\I386\WRDWIZFLT.SYS; DestDir: {win}\System32\DRIVERS; Flags: ignoreversion 32bit onlyifdoesntexist
Source: RequiredFiles\DRIVERS\BATFILES\STOPWRDWIZFLT.BAT; DestDir: {app}\DRIVERS; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\INSTALL.CMD; DestDir: {app}\DRIVERS; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\STOP.CMD; DestDir: {app}\DRIVERS; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\UNINSTALL.CMD; DestDir: {app}\DRIVERS; Flags: ignoreversion
...
Source: ..\Release\Win32\Binaries\WRDWIZFW.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZEMAILSCN.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZRESCUEDISK.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Common\TPLIB\BDF\redist\Win32\FIREWALL.XML; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Common\TPLIB\BDF\redist\SETTINGS.BIN; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: SETTINGS\ESSENTIALPLUSSETTING\PRODUCTSETTINGS.INI; DestDir: {app}\WRDSETTINGS; Flags: ignoreversion overwritereadonly onlyifdoesntexist 
...
Source: SETTINGS\UPDATESERVERS.INI; DestDir: {app}\WRDSETTINGS; Flags: ignoreversion overwritereadonly onlyifdoesntexist
Source: SETTINGS\ESSENTIALPLUSSETTING\WardwizEmailScan\EMAILSCANCLIENTS.INI; DestDir: {app}\WRDSETTINGS; Flags: ignoreversion overwritereadonly onlyifdoesntexist
...
Source: RequiredFiles\WRDWIZHELP\WRDWIZESSPLUS\WRDWIZESSPLUS.CHM; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\TPDLLS\Win32\NFAPI.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\Win32\PROTOCOLFILTERS.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\Win32\LIBEAY32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\Win32\SSLEAY32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPAPPS\Win32\NFREGDRV.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\SETUPDB\WWIZPARBLK.DB; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
//external 'RemoveDriverService@{app}\WRDWIZSETUPDLL.DLL cdecl uninstallonly';
...
begin
  ...
  //Issue - Vibranium AV is getting installed at multiple location.
...
begin
      path :=  GetEnv('ALLUSERSPROFILE')
       if FileExists(path+'\Vibranium Antivirus\WRDWIZUSERREG.DB')
       then
       begin
          RenameFile(path+'\Vibranium Antivirus\WRDWIZUSERREG.DB',path+'\WRDWIZUSERREG.DB') ;
          DelTree(path+'\Vibranium Antivirus\*', False, True, True);
           RenameFile(path+'\WRDWIZUSERREG.DB',path+'\Vibranium Antivirus\WRDWIZUSERREG.DB') ;
          end
        else
     DelTree(path+'\Vibranium Antivirus\*', False, True, True);
end;
