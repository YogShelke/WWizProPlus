...
OutputDir=.\Output
OutputBaseFilename=installerEx64
...
[Messages]
SetupAppTitle=installerEx64
SetupWindowTitle=installerEx64 - %1
...
[Files]
Source: RequiredFiles\PROTECTION\64\{#FPSCANNER}; DestDir: {tmp}\DRIVERS; Flags: ignoreversion 
Source: RequiredFiles\PROTECTION\64\{#PPSECURE64}; DestDir: {tmp}\DRIVERS; Flags: ignoreversion
...
Source: Output\incompcheckx64.exe; DestDir: {tmp}; Flags:dontcopy

[Code]
var
UpdateExeName,GetExplorerExePath,ExplorerExeName,Wrdwiz_Secure64,wrdwiz_scanner,GetParenttempfolder,GetProductName,GetWWIZFolder,GetWWIZDriverFolder,GetTempDriverFolder,GetWWizAppFolderPath,GetInstallerExePath,GetWWizPLUGINSPath,GetWWizDBPath,Finaltemppath,Gettempfolder,GetProductVersion,ProdSettigsIni,GetTempFolderInstallerPath:String;
Resultcode:Integer;
Winhwnd:longint;
...
function RegisterInstallerWithDrivers(const ProtectInstallerExeName:String): integer;
...
begin
  ...
  DelTree(ExpandConstant('{tmp}\WRDWIZSETUPDLL\WRDWIZSETUPDLL'), True, True, True);
	...
	begin	
      ...
      GetProductName:=('{#SetupSetting("OutputBaseFilename")}');
	    RegisterInstallerWithDrivers(GetProductName);
			Gettempfolder:=ExpandConstant('{tmp}');
			ProtectFolder(Gettempfolder);
			GetParenttempfolder:=ExpandConstant(ParamStr(0));
			ProtectFolder(GetParenttempfolder);
	end;
	RegWriteDWordValue(HKEY_LOCAL_MACHINE,'Software\Wardwiz','dwIsOffline', 1);
  ...
  repeat
  UpdateExeName:='WRDWIZUPDATE.EXE';
	if IsAppRunning(UpdateExeName) then
	begin
	      PauseProtectionDrivers();
        Exec(ExpandConstant('taskkill.exe'), '/f /im ' + '"' + UpdateExeName + '"', '', SW_HIDE,ewWaitUntilTerminated, ResultCode);
	end;
  ...
  begin		
	     PauseInstallerProtectionDrivers(17);
			 ...
			 if FileExists(ExpandConstant('{tmp}\incompcheckx64.exe')) then
			 begin
				DelayDeleteFile(ExpandConstant('{tmp}\*.*'), 2);
				DelTree(ExpandConstant('{tmp}'), True, True, True);
			 end;
			 if FileExists(ExpandConstant('{tmp}\WRDWIZINSTALLER.EXE')) then
			 begin
					DelayDeleteFile(ExpandConstant('{tmp}\WRDWIZINSTALLER.EXE'), 5);
			 end;
			 DelTree(ExpandConstant('{tmp}'), True, True, True);
			 ExitProcess(0);
  end
	...
	begin
		...
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCIx64.exe.ini');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCIx64.exe_4_0.tmp');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCIx64.exe_4_1.tmp');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCIx64.exe_4_2.tmp');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCIx64.exe_4_3.tmp');
	end 
	else if FileExists(Finaltemppath+'\WWizDMNCGB.INI') then
	begin
		DeleteFile(Finaltemppath+'\WWizDMNCGB.INI');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCGx64.exe.ini');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCGx64.exe_4_0.tmp');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCGx64.exe_4_1.tmp');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCGx64.exe_4_2.tmp');
		DeleteFile(Finaltemppath+'\WardWizBasicSetupNCGx64.exe_4_3.tmp');
	end 
	else if FileExists(Finaltemppath+'\WWizDMNCIEss.INI') then
	begin
	    DeleteFile(Finaltemppath+'\WWizDMNCIEss.INI');
		DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCIx64.exe.ini');
		DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCIx64.exe_4_0.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCIx64.exe_4_1.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCIx64.exe_4_2.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCIx64.exe_4_3.tmp');
	end 
	else if FileExists(Finaltemppath+'\WWizDMNCGEss.INI') then
	begin
		DeleteFile(Finaltemppath+'\WWizDMNCGEss.INI');
	    DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCGx64.exe.ini');
	    DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCGx64.exe_4_0.tmp');
	    DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCGx64.exe_4_1.tmp');
	    DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCGx64.exe_4_2.tmp');
	    DeleteFile(Finaltemppath+'\WardWizEssentialSetupNCGx64.exe_4_3.tmp');
	   end 
	   else if FileExists(Finaltemppath+'\WWizDMNCIEssPlus.INI') then
	begin
		DeleteFile(Finaltemppath+'\WWizDMNCIEssPlus.INI');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCIx64.exe.ini');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCIx64.exe_4_0.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCIx64.exe_4_1.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCIx64.exe_4_2.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCIx64.exe_4_3.tmp');
	end 
	else if FileExists(Finaltemppath+'\WWizDMNCGEssPlus.INI') then
	begin
		DeleteFile(Finaltemppath+'\WWizDMNCGEssPlus.INI');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCGx64.exe.ini');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCGx64.exe_4_0.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCGx64.exe_4_1.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCGx64.exe_4_2.tmp');
		DeleteFile(Finaltemppath+'\WardWizEssPlusSetupNCGx64.exe_4_3.tmp');
	end 
	   else if FileExists(Finaltemppath+'\WWizDMNCIPro.INI') then
	begin
	       DeleteFile(Finaltemppath+'\WWizDMNCIPro.INI');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCIx64.exe.ini');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCIx64.exe_4_0.tmp');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCIx64.exe_4_1.tmp');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCIx64.exe_4_2.tmp');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCIx64.exe_4_3.tmp');
	end 
	else if FileExists(Finaltemppath+'\WWizDMNCGPro.INI') then
	begin
	   DeleteFile(Finaltemppath+'\WWizDMNCGPro.INI');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCGx64.exe.ini');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCGx64.exe_4_0.tmp');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCGx64.exe_4_1.tmp');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCGx64.exe_4_2.tmp');
		DeleteFile(Finaltemppath+'\WardWizProSetupNCGx64.exe_4_3.tmp');
	     end;
	    if FileExists(ExpandConstant('{tmp}\incompcheckx64.exe')) then
		begin
			DelayDeleteFile(ExpandConstant('{tmp}\*.*'), 2);
