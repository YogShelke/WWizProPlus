...
english.CM_3_WWSetupDllOutlookCloseUnInstall =আউটলুক আবেদন Vibranium আনইনস্টল করার আগে বন্ধ করা দরকার। ঘনিষ্ঠ এবং পুনরায় চেষ্টা করুন বাটনে ক্লিক করুন।
...
Source: Output\VibroTSPreScnX64.EXE; DestDir: {tmp}; Flags: dontcopy
...
;Source: RequiredFiles\TPAPPS\x64\WRDWIZARC.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
ErrorCode:Integer;
begin
ExtractTemporaryFile('VibroTSPreScnX64.EXE');
GetSelectedLanguage:=ExpandConstant('{language}');
             GetTempFolderPreInstScanExePath:=ExpandConstant('{tmp}\VibroTSPreScnX64.EXE');
