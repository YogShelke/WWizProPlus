...
OutputDir=.\Output
OutputBaseFilename=WardWizBasicSetupNCGx64
...
Source: VCL Styles\VclStylesinno.dll; DestDir: BeforeInstall:GetExtractFiles;Flags: dontcopy overwritereadonly
...
//lalit 2-3-2015 issue :-During uninstallation if I my UI is running and it asks for close UI
//but then if I try to cancel the Uninstallation it doesn’t happen
...
external 'RegisterInstallerWithDrivers@files:WRDWIZSETUPDLL.DLL cdecl setuponly';
...
// lalit 2-3-2015 If I have With Clam setup and I install without clam setup then it
//does not delete old setup of With clam setup.
...
//Issue: On Reinstallation Restart Now message should be within Setup window and not as MessageBox
//Resolved By: Nitin K. Date: 28th April 2015
...
begin
 ...
 // resolved by lalit kumawat 8-31-2015
  ...
  WizardForm.NextButton.Enabled:=True;
	...
	// lalit 2-3-2015 If I have With Clam setup and I install without clam setup then
	// it does not delete old setup of With clam setup.
