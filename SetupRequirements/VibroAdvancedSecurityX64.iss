...
#define AppVer ReadIni("C:\AcutokWinDev_1.2\ACBinary.ini", "ProductVersion", "ProductVer", "2.0.0.1")
#define DataVer ReadIni("C:\AcutokWinDev_1.2\ACBinary.ini", "DatabaseVersion", "DatabaseVer", "1.1.3.1")
#define DataEncVer ReadIni("C:\AcutokWinDev_1.2\ACBinary.ini", "DataEncVersion", "DataEncVer", "1.0")
#define ScanEngVer ReadIni("C:\AcutokWinDev_1.2\ACBinary.ini", "ScanEngineVersion", "ScanEngineVer", "3.2.0.4")
...
#define SupportNumberClam ReadIni("C:\AcutokWinDev_1.2\ACBinary.ini", "SupportNo", "SupportNumberClam", "1800-270-2599")
#define SupportNumberNC ReadIni("C:\AcutokWinDev_1.2\ACBinary.ini", "SupportNo", "SupportNumberNC", "1800-270-2599")
...
;Source: RequiredFiles\SAVAPI\x64\*; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion 64bit onlyifdoesntexist
;Source: RequiredFiles\DRIVERS\WFP\AMD64\AKFLT.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion 64bit onlyifdoesntexist
...
Source: RequiredFiles\CPPRESTRIBUTABLES\{#REDESTRIBUTABLES}; BeforeInstall: GetExtractFiles; Flags: dontcopy nocompression
...
Source: ..\Release\x64\Binaries\VBUI.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBUSBDETECTUI.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBCOMMSRV.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBTRAY.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
Source: ..\Release\x64\Binaries\VBUSBDETECT.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBSCANDLL.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBINDEX.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBREPAIRDLL.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBREGISTRATION.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBREGISTERDATA.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBRKSCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBRESOURCE.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBCLOSEALL.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBALUSRV.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBHASH.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBEXTRACT.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
Source: ..\Release\x64\Binaries\VBSHELLEXT.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion regserver noregerror  overwritereadonly
Source: ..\Release\x64\Binaries\VBUNINST.exe; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion
Source: ..\Release\x64\Binaries\VBHEUSCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBAUTORUNSCN.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBTEMPCLR.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBUSBVAC.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\ACUTOKUTILITY.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBCRYPT.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBOFFLINEREG.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBBOOTSCN.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBUPDATE.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBRESCUEDISK.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBFW.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBEMAILSCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\EVALREGDLLS\x64\VBEVALREG.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion onlyifdoesntexist overwritereadonly
...
;Source: RequiredFiles\ACUTOKHELP\ACUTOK\ACUTOKGERMAN.CHM; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: RequiredFiles\VIBRANIUMSECURITYNEWS\VIBRANIUMSECURITYNEWS.TXT; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
Source: ..\Release\x64\Binaries\VBMD5SCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\UNRAR\x64\UNRAR.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\SCITERDLL\64\SCITER64.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\SQLITE\64\SQLITE3.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\SQLITE\64\TISCRIPT-SQLITE.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\x64\NFAPI.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\x64\PROTOCOLFILTERS.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\x64\LIBEAY32.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\x64\SSLEAY32.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPAPPS\x64\NFREGDRV.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\VBPOLYSCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\BDS\x64\*; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion recursesubdirs createallsubdirs  overwritereadonly
...
Source: RequiredFiles\TPDLLS\x64\7-ZIP32.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly regserver
Source: RequiredFiles\TPDLLS\x64\7Z.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPAPPS\x64\7Z.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\TPAPPS\Win32\ACUTOKRMTAST.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Source: ..\Release\x64\Binaries\VBREGTOOL.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
[UninstallRun]
Filename: {app}\ACUTOKCLOSEALL.EXE; Flags: runminimized runhidden
...
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwBrowserSecurityState; ValueData: 0; Flags: createvalueifdoesntexist uninsdeletekey noerror
...
begin
      path :=  GetEnv('ALLUSERSPROFILE')
       if FileExists(path+'\WardWiz Antivirus\VIBRANIUMUSERREG.DB')
       then
       begin
          RenameFile(path+'\WardWiz Antivirus\VIBRANIUMUSERREG.DB',path+'\VIBRANIUMUSERREG.DB') ;
          DelTree(path+'\WardWiz Antivirus\*', False, True, True);
           RenameFile(path+'\VIBRANIUMUSERREG.DB',path+'\WardWiz Antivirus\VIBRANIUMUSERREG.DB') ;
          end
        else
     DelTree(path+'\WardWiz Antivirus\*', False, True, True);
end;
