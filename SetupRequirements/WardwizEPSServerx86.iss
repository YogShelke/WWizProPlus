...
OutputDir=.\Output
OutputBaseFilename=WardWizEPSServerSetupx86
...
Source: RequiredFiles\DRIVERS\TDI\I386\WRDWIZFLT.SYS; DestDir: {win}\System32\DRIVERS; Flags: ignoreversion onlyifdoesntexist
Source: RequiredFiles\DRIVERS\WFP\WINDOWS7\I386\WRDWIZFLT07.SYS; DestDir: {win}\System32\DRIVERS; Flags: ignoreversion
Source: RequiredFiles\DRIVERS\WFP\WINDOWS8\I386\WRDWIZFLT08.SYS; DestDir: {win}\System32\DRIVERS; Flags: ignoreversion
Source: RequiredFiles\DRIVERS\WFP\WINDOWS10\I386\WRDWIZFLT10.SYS; DestDir: {win}\System32\DRIVERS; Flags: ignoreversion
...
Source: ..\Release\Win32\Binaries\WRDWIZCLIENTAGENT.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\SQLITE\32\SQLITE3_32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Source: ..\Release\Win32\Binaries\WRDWIZDPLSRV.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\CPPREST120_2_9.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\CPPREST120_XP_2_9.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\LIBCRYPTO-1_1.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\libcurl.dll; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\LIBSSH2.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\LIBSSL-1_1.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\MSVCP120.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\MSVCR120.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\CPPRESET\Win32\ZLIB1.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\DOTNETFRAMEWORK\x86_CONFIGURATIONFILE.INI; DestDir: {tmp}; Flags: dontcopy
...
Source: RequiredFiles\DOTNETFRAMEWORK\x86_CONFIGUNINSTALLSQLSERVERCMDFILE.INI; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Filename: REG.exe; Parameters: "ADD ""HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{{078ABE62-583D-43e6-96D6-5D092883DC82}_is1"" /V ""UninstallString"" // ""REG_SZ"" /D ""\""{app}\WRDWIZUNINST.exe\"" /SILENT"" /F"; StatusMsg: {cm:CMWWInstallStatusMSG}; Flags: RunHidden WaitUntilTerminated
Filename: REG.exe; Parameters: "ADD ""HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{{078ABE62-583D-43e6-96D6-5D092883DC82}_is1"" /V ""QuietUninstallString"" // ""REG_SZ"" /D ""\""{app}\WRDWIZUNINST.exe\"" /SILENT"" /F"; StatusMsg: {cm:CMWWInstallStatusMSG}; Flags: RunHidden WaitUntilTerminated
...
begin
	...
	if (S_ver = '11.0.2100.60') then
      ...
      ExtractTemporaryFile('x86_CONFIGURATIONFILE.INI');
      ConfigIniFileName := ExpandConstant('{tmp}\x86_CONFIGURATIONFILE.ini');
      ...
      GetSqlServerConfigFileCmd:='"'+ExpandConstant('{tmp}\x86_CONFIGURATIONFILE.ini')+'"';
