...
OutputDir=.\Output
OutputBaseFilename=WardWizProSetupNCGx64
...
Source: RequiredFiles\PROTECTION\64\{#FPSCANNER}; DestDir: {app}\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: RequiredFiles\PROTECTION\64\{#PPSECURE64}; DestDir: {app}\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
;Source: RequiredFiles\PROTECTION\32\{#PPXPROC}; DestDir: {app}\DRIVERS; Flags: ignoreversion
Source: RequiredFiles\DRIVERS\TDI\AMD64\WRDWIZFLT.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 64bit
Source: RequiredFiles\DRIVERS\WFP\WINDOWS7\AMD64\WRDWIZFLT07.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 64bit
Source: RequiredFiles\DRIVERS\WFP\WINDOWS8\AMD64\WRDWIZFLT08.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 64bit
Source: RequiredFiles\DRIVERS\WFP\WINDOWS10\AMD64\WRDWIZFLT10.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 64bit
...
Source: ..\Release\x64\Binaries\WRDWIZUI.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZUSBDETECTUI.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZCOMMSRV.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZTRAY.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Source: ..\Release\x64\Binaries\WRDWIZUSBDETECT.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZSCANDLL.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZINDEX.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZREPAIRDLL.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZREGISTRATION.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZREGISTERDATA.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZRKSCN.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZRESOURCE.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZCLOSEALL.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZALUSRV.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZHASH.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZEXTRACT.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Source: ..\Release\x64\Binaries\WRDWIZSHELLEXT.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion regserver noregerror  overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZUNINST.exe; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: ..\Release\x64\Binaries\WRDWIZHEUSCN.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZHEUSCN32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZAUTORUNSCN.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZTEMPCLR.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZUSBVAC.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZUTILITY.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZCRYPT.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZEXTRACT32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZEMAILADDIN32.DLL; DestDir: {app}; Flags: ignoreversion regserver 32bit overwritereadonly sharedfile noregerror
;Source: ..\Release\x64\Binaries\WRDWIZREGISTERDATA32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZREGISTRATION32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZREPAIRDLL32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZSCANDLL32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZEMAILADDIN.DLL; DestDir: {app}; Flags: ignoreversion regserver overwritereadonly sharedfile noregerror
Source: ..\Release\x64\Binaries\WRDWIZOFFLINEREG.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZBOOTSCN.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZUPDATE.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZRESCUEDISK.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: SETTINGS\PROPRDSETTING\PRODUCTSETTINGS.INI; DestDir: {app}\WRDSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly onlyifdoesntexist
Source: SETTINGS\EXEXT.INI; DestDir: {app}\WRDSETTINGS;  BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: SETTINGS\UPDATESERVERS.INI; DestDir: {app}\WRDSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly onlyifdoesntexist
...
Source: Logo\COMPANYLOGO.ICO; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: RequiredFiles\EMAILSCAN\WRDWIZSIGNATUREEMAIL.DB; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: RequiredFiles\EMAILSCAN\WRDWIZMALICIOUSSITES.DB; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: RequiredFiles\UNRAR\x64\UNRAR32.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: RequiredFiles\UNRAR\x64\UNRAR.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: RequiredFiles\EVALREGDLLS\x64\WRDWIZEVALREG.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion onlyifdoesntexist overwritereadonly
...
Source: RequiredFiles\WRDWIZHELP\WRDWIZPRO\WRDWIZAVPRO.CHM; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: RequiredFiles\WRDWIZHELP\WRDWIZPRO\WRDWIZAVPROGERMAN.CHM; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: RequiredFiles\WRDWIZSECURITYNEWS\WRDWIZSECURITYNEWS.TXT; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZMD5SCN.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZMD5SCN32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Source: ..\Release\x64\Binaries\WRDWIZPOLYSCN.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Source: ..\Release\x64\Binaries\WRDWIZREGTOOL.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: string; ValueName: DataBaseVersion; ValueData: {#DataVer}; Flags: uninsdeletekey
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: string; ValueName: ScanType; ValueData: {code:GetScanType| -1}; Flags: uninsdeletekey
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwProductID; ValueData: 2; Flags: uninsdeletekey
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz\EmailScanSetting; ValueType: DWORD; ValueName: dwAttachScanAction; ValueData: {code:GetdwAttachScanAction| 1}; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz\EmailScanSetting; ValueType: DWORD; ValueName: dwEnableContentFilter; ValueData: {code:GetdwEnableContentFilter| 1}; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz\EmailScanSetting; ValueType: DWORD; ValueName: dwEnableSpamFilter; ValueData: {code:GetdwEnableSpamFilter| 1}; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz\EmailScanSetting; ValueType: DWORD; ValueName: dwEnableVirusScan; ValueData: {code:GetdwEnableVirusScan| 1}; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz\EmailScanSetting; ValueType: DWORD; ValueName: dwEnableSignature; ValueData: {code:GetdwEnableSignature| 1}; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz\EmailScanSetting; ValueType: DWORD; ValueName: dwReloadSettings; ValueData: {code:GetdwReloadSettings| 0}; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz\EmailScanSetting; ValueType: dword; ValueName: dwAllowVirusPopUp; ValueData: {code:GetdwAllowVirusPopUp| 1}; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwEmailScan; ValueData: {code:GetdwEmailScan| 1}; Flags: uninsdeletekey noerror createvalueifdoesntexist
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwIsOffline; ValueData: {code:GetdwIsOffline| 0}; Flags: uninsdeletekey noerror
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwLocID; ValueData: 1; Flags: uninsdeletekey noerror
...
var
ParamAssign:Integer;
GetSetupDllPath,GetCurrentFileName,GetFileNameShowForm:String;
...
// Function to GetdwShowStartupTips Data
...
// Function to dwAttachScanAction
function GetdwAttachScanAction(Value_Name : string): string;
         var Value_Data : Cardinal;
         var temp_data : string;
          var check : Boolean;
 begin
      check := RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwAttachScanAction', Value_Data);
      temp_data := IntToStr(Value_Data);
...
// Function to GetdwEnableContentFilter
function GetdwEnableContentFilter(Value_Name : string): string;
         var Value_Data : Cardinal;
         var temp_data : string;
          var check : Boolean;
 begin
      check := RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwEnableContentFilter', Value_Data);
      temp_data := IntToStr(Value_Data);
...
// Function to GetdwEnableSpamFilter
function GetdwEnableSpamFilter(Value_Name : string): string;
         var Value_Data : Cardinal;
         var temp_data : string;
          var check : Boolean;
 begin
      check := RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwEnableSpamFilter', Value_Data);
      temp_data := IntToStr(Value_Data);
 ...
 // Function to GetdwEnableVirusScan
function GetdwEnableVirusScan(Value_Name : string): string;
         var Value_Data : Cardinal;
         var temp_data : string;
          var check : Boolean;
 begin
      check := RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwEnableVirusScan', Value_Data);
      temp_data := IntToStr(Value_Data);
 ...
 // Function to GetdwEnableSignature
function GetdwEnableSignature(Value_Name : string): string;
         var Value_Data : Cardinal;
         var temp_data : string;
          var check : Boolean;
 begin
      check := RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwEnableSignature', Value_Data);
      temp_data := IntToStr(Value_Data);
 ...
 // Function to GetdwReloadSettings
function GetdwReloadSettings(Value_Name : string): string;
         var Value_Data : Cardinal;
         var temp_data : string;
          var check : Boolean;
 begin
      check := RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwReloadSettings', Value_Data);
      temp_data := IntToStr(Value_Data);
 ...
 // Function to GetdwAllowVirusPopUp
function GetdwAllowVirusPopUp(Value_Name : string): string;
         var Value_Data : Cardinal;
         var temp_data : string;
          var check : Boolean;
 begin
      check := RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwAllowVirusPopUp', Value_Data);
      temp_data := IntToStr(Value_Data);
 ...
 // Function to GetdwEmailScan
function GetdwEmailScan(Value_Name : string): string;
         var Value_Data : Cardinal;
         var temp_data : string;
          var check : Boolean;
 begin
      check := RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwEmailScan', Value_Data);
      temp_data := IntToStr(Value_Data);
...
begin
		...
		if(ResultCode = 5) or (ResultCode = 10) or (ResultCode = 6) then
		begin
			command := 'WRDWIZFLT';
		end;
...
begin
  ...
  if (CurPage = 1) then
   ...
   begin
	...
	//ExitProcess(0);
	//end;
    Result := CheckForPreviousVersion('PRO',CurrentVersion, false);
