...
#define MyAppName "Vibranium Threat Security"
#define MyAppVersion "2.0.0.1"
#define MyAppPublisher "Vibranium Threat Security"
...
#define MyWardWizAppName "Vibranium Threat Security"
...
Source: SETTINGS\ESSENTIALSETTING\PRODUCTSETTINGS.INI; DestDir: {app}\VBSETTINGS; Flags: ignoreversion overwritereadonly
...
;Source: RequiredFiles\WRDWIZHELP\WRDWIZESS\VibroTS.CHM; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
ErrorCode:Integer;
begin
ExtractTemporaryFile('VibroTSPreScnX86.EXE');
GetSelectedLanguage:=ExpandConstant('{language}');
             GetTempFolderPreInstScanExePath:=ExpandConstant('{tmp}\VibroTSPreScnX86.EXE');
