...
;#define MyWelcomeMsg2 "This will install WardWiz Patch version 1.8.3.0 on your computer"
...
OutputDir=.\Output
OutputBaseFilename=WardWizProPatchIx64
...
;Source: RequiredFiles\UNRAR\x86\UNRAR32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\BDSENGINEFILES\x64\*; DestDir: {app}\PLUGINS; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZPOLYSCN.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
// lalit 5-9-2015 in silent mode custom confirmation message box handling
