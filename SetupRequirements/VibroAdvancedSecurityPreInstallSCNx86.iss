...
OutputDir=.\Output
OutputBaseFilename=VibroASPreSCNx86
...
Source: RequiredFiles\VIBRANIUMSECURITYNEWS\VIBRANIUMSECURITYNEWS.TXT; DestDir: {tmp}; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
