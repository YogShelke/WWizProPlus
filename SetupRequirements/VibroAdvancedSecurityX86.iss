...
#define AppVer ReadIni("D:\AcutokWinDev_1.2\ACBinary.ini", "ProductVersion", "ProductVer", "2.0.0.1")
#define DataVer ReadIni("D:\AcutokWinDev_1.2\ACBinary.ini", "DatabaseVersion", "DatabaseVer", "1.1.3.1")
#define DataEncVer ReadIni("D:\AcutokWinDev_1.2\ACBinary.ini", "DataEncVersion", "DataEncVer", "1.0")
#define ScanEngVer ReadIni("D:\AcutokWinDev_1.2\ACBinary.ini", "ScanEngineVersion", "ScanEngineVer", "2.5.1.0")
...
#define SupportNumberClam ReadIni("D:\AcutokWinDev_1.2\ACBinary.ini", "SupportNo", "SupportNumberClam", "1800-270-2599")
#define SupportNumberNC ReadIni("D:\AcutokWinDev_1.2\ACBinary.ini", "SupportNo", "SupportNumberNC", "")

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{7F2935F4-F652-4E3E-BD71-0F1B4C91D5B1}
AppName={#MyAppName}
AppVersion={#AppVer}
...
;german.CMWWPackgNotSupported =Die Installation wird von diesem Betriebssystem nicht unterstützt. Bitte laden Sie die VIBRANIUM 64-Bit Setup-Datei herunter.
...
[Files]
;Source: RequiredFiles\SVDB\*; DestDir: {app}\SVDB; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\VBDB\*; DestDir: {app}\VBDB; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: RequiredFiles\DRIVERS\WFP\I386\AKFLT.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion 32bit onlyifdoesntexist
Source: RequiredFiles\DRIVERS\BATFILES\STOPACUTOKFLT.BAT; DestDir: {app}\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\IGNIS.SYS; DestDir: {app}\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\IGNIS.INF; DestDir: {app}\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\INSTALL.CMD; DestDir: {app}\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\IGNIS_STOP.CMD; DestDir: {app}\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\STOP.CMD; DestDir: {app}\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\Win32\UNINSTALL.CMD; DestDir: {app}\DRIVERS; BeforeInstall: GetExtractFiles; Flags: ignoreversion
...
Source: VCL Styles\AmethystKamri.vsf; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: dontcopy overwritereadonly
Source: ..\Release\Win32\Binaries\VBUI.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBALUSRV.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBUSBDETECTUI.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBCOMMSRV.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBTRAY.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBSETUPDLL.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBUSBDETECT.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBSCANDLL.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBINDEX.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBREPAIRDLL.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBREGISTRATION.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBREGISTERDATA.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBRKSCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBRESOURCE.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBCLOSEALL.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBHASH.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBEXTRACT.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
Source: ..\Release\Win32\Binaries\VBSHELLEXT.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion regserver 32bit noregerror  overwritereadonly
Source: ..\Release\Win32\Binaries\VBUNINST.exe; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion
Source: ..\Release\Win32\Binaries\VBHEUSCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBAUTORUNSCN.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBTEMPCLR.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBUSBVAC.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
;Source: ..\Release\Win32\Binaries\VBUTILITY.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBCRYPT.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBOFFLINEREG.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBBOOTSCN.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBUPDATE.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBRESCUEDISK.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBFW.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBEMAILSCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Common\TPLIB\BDF\redist\Win32\IGNIS.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Common\TPLIB\BDF\redist\Win32\FIREWALL.XML; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Common\TPLIB\BDF\redist\SETTINGS.BIN; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: SETTINGS\ESSENTIALPLUSSETTING\PRODUCTSETTINGS.INI; DestDir: {app}\VBSETTINGS; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly onlyifdoesntexist
Source: SETTINGS\ESSENTIALPLUSSETTING\ACF.INI; DestDir: {app}\VBSETTINGS; Flags: ignoreversion overwritereadonly
Source: SETTINGS\EXEXT.INI; DestDir: {app}\VBSETTINGS; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: SETTINGS\UPDATESERVERS.INI; DestDir: {app}\VBSETTINGS; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly onlyifdoesntexist
Source: SETTINGS\ESSENTIALPLUSSETTING\VibroEmailScan\EMAILSCANCLIENTS.INI; DestDir: {app}\VBSETTINGS; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly onlyifdoesntexist
;Source: SETTINGS\CHINESE.INI; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: SETTINGS\ENGLISH.INI; DestDir: {app}\VBSETTINGS; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
;Source: SETTINGS\FRENCH.INI; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
;Source: SETTINGS\GERMAN.INI; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
;Source: SETTINGS\HINDI.INI; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion  overwritereadonly
;Source: SETTINGS\SPANISH.INI; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: SETTINGS\ENGLISHTIPS.txt; DestDir: {app}\VBSETTINGS; BeforeInstall: GetExtractFiles; Flags: ignoreversion 32bit overwritereadonly
;Source: SETTINGS\HINDITIPS.txt; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 32bit overwritereadonly
;Source: SETTINGS\CHINESETIPS.TXT; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 32bit overwritereadonly
;Source: SETTINGS\FRENCHTIPS.TXT; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 32bit overwritereadonly
;Source: SETTINGS\GERMANTIPS.TXT; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 32bit overwritereadonly
;Source: SETTINGS\SPANISHTIPS.TXT; DestDir: {app}\VBSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 32bit overwritereadonly
Source: Logo\COMPANYLOGO.ICO; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion  overwritereadonly
Source: RequiredFiles\EVALREGDLLS\x86\VBEVALREG.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion onlyifdoesntexist overwritereadonly
...
;Source: RequiredFiles\ACUTOKHELP\ACUTOK\ACUTOK.CHM; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\ACUTOKHELP\ACUTOK\ACUTOK.CHM; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: RequiredFiles\VIBRANIUMSECURITYNEWS\VIBRANIUMSECURITYNEWS.TXT; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly recursesubdirs createallsubdirs 32bit
Source: ..\Release\Win32\Binaries\VBMD5SCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\TPDLLS\Win32\NFAPI.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\Win32\PROTOCOLFILTERS.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\Win32\LIBEAY32.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPDLLS\Win32\SSLEAY32.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPAPPS\Win32\NFREGDRV.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\VBPOLYSCN.DLL; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\NSS\*; DestDir: {app}\NSS; BeforeInstall: GetExtractFiles; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
Source: RequiredFiles\SETUPDB\VBPARBLK.DB; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
;Source: RequiredFiles\TPAPPS\Win32\VBRMTAST.EXE; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: RequiredFiles\SETUPDB\VBBROWSEC.DB; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\NSS\*; DestDir: {app}\NSS; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
Source: ..\Release\Win32\Binaries\VBREGTOOL.EXE; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
Source: Output\VibroASPreSCNx86.EXE; DestDir: {tmp}; Flags: dontcopy
...
Filename: REG.exe; Parameters: "ADD ""HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{{7F2935F4-F652-4E3E-BD71-0F1B4C91D5B1}_is1"" /V ""UninstallString"" /T ""REG_SZ"" /D ""\""{app}\VBUNINST.exe\"" /SILENT"" /F"; StatusMsg: {cm:CMWWInstallStatusMSG}; Flags: RunHidden WaitUntilTerminated
Filename: REG.exe; Parameters: "ADD ""HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{{7F2935F4-F652-4E3E-BD71-0F1B4C91D5B1}_is1"" /V ""QuietUninstallString"" /T ""REG_SZ"" /D ""\""{app}\VBUNINST.exe\"" /SILENT"" /F"; StatusMsg: {cm:CMWWInstallStatusMSG}; Flags: RunHidden WaitUntilTerminated
...
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: string; ValueName: LastLiveupdatedt; ValueData: {code:Date} {code:Time}; Flags: uninsdeletekey; Tasks: ; Languages: 
...
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwUsbScan; ValueData: {code:GetdwUsbScan| 2}; Flags: uninsdeletekey noerror dontcreatekey createvalueifdoesntexist
...
Root: HKCR; Subkey: .AK; ValueType: string; ValueName: ; ValueData: {#ResIconReg}; Flags: uninsdeletekey
Root: HKCR; Subkey: .*.AK; ValueType: string; ValueName: ; ValueData: {#ResIconReg}; Flags: uninsdeletekey
...
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwCachingMethod; ValueData: 0; Flags: uninsdeletekey noerror
...
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwStealthMode; ValueData: 1; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwPortScanProt; ValueData: 1; Flags: uninsdeletekey noerror createvalueifdoesntexist
...
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwBrowserSecurityState; ValueData: 1; Flags: createvalueifdoesntexist uninsdeletekey noerror
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwParentalCntrlFlg; ValueData: 0; Flags: createvalueifdoesntexist uninsdeletekey noerror
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwEmailScanState; ValueData: 1; Flags: createvalueifdoesntexist uninsdeletekey noerror
...
var
ParamAssign:Integer;
GetFailedMsg,GetFirstAppMsg,GetSecondAppMsg,CurrentVersion,GetCloseAppMsg,GetProductName,GetWWiZAppPath,Gettempfolder,GetfinalCmd,GetSetupDllPath,GetCurrentFileName,GetFileNameShowForm:String;
...
//external 'RemoveDriverService@{app}\VBSETUPDLL.DLL cdecl uninstallonly';
...
external 'LaunchInstallFilesProgressBar@files:VBSETUPDLL.DLL cdecl setuponly';

function ProtectFolder(const ProtectFolerPath:String): integer;
external 'ProtectFolder@files:VBSETUPDLL.DLL cdecl setuponly';

function RegisterInstallerFinalSetupWithDrivers(const FinalSetupName:String): integer;
external 'RegisterInstallerFinalSetupWithDrivers@files:VBSETUPDLL.DLL cdecl setuponly';

function PauseInstallerProtectionDrivers(const ProcessID:Integer): integer;
external 'PauseInstallerProtectionDrivers@files:VBSETUPDLL.DLL cdecl setuponly';

function CloseAllwwizAplication(): Boolean;
external 'CloseAllwwizAplication@files:VBSETUPDLL.DLL cdecl setuponly';
...
external 'InstallerCheckForPreviousVersion@files:VBSETUPDLL.DLL cdecl setuponly';

function SetupInstallingFinished(IsInstallSuccess:Boolean):Boolean;
external 'SetupInstallingFinished@files:VBSETUPDLL.DLL cdecl setuponly';
...
ErrorCode:Integer;
begin
ExtractTemporaryFile('VibroASPreSCNx86.EXE');
GetSelectedLanguage:=ExpandConstant('{language}');
             GetTempFolderPreInstScanExePath:=ExpandConstant('{tmp}\VibroASPreSCNx86.EXE');
...
CurrentPath: string;
bAddFailed : Boolean;
ErrorCode,IsInstall,ResultCode:Integer;
//Issue No-24 While installing the same setup again it should be "Latest version of Wardwiz is already installed"
 ...
 // resolved by lalit kumawat 8-31-2015
   if CompareText(GetfinalCmd,'/verysilent')= 0 then
    begin
			...
			InstallerCheckForPreviousVersion(GetFirstAppMsg,GetSecondAppMsg,'ESSENTIALPLUS',CurrentVersion ,false);
    ...
    begin
		  ...
		  Exec(ExpandConstant('{app}\DRIVERS\STOPACUTOKFLT.BAT'), '', '', SW_HIDE, ewWaitUntilTerminated, ErrorCode);
  ...
  if CompareText(GetfinalCmd,'/verysilent')= 0 then
   ...
   RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{7F2935F4-F652-4E3E-BD71-0F1B4C91D5B1}_is1',
  ...
  usPostUninstall:
     ...
     usDone: // lalit 2-3-2015 in silent mode successful uninstallation messge
      begin
       ...
       if RegKeyExists(HKEY_CLASSES_ROOT,'.AK')then
         begin
          RegDeleteKeyIncludingSubkeys(HKEY_CLASSES_ROOT,'.AK');
         end;
...
begin
      path :=  GetEnv('ALLUSERSPROFILE')
       if FileExists(path+'\WardWiz Antivirus\VBUSERREG.DB')
       then
       begin
          RenameFile(path+'\WardWiz Antivirus\VBUSERREG.DB',path+'\VBUSERREG.DB') ;
          DelTree(path+'\WardWiz Antivirus\*', False, True, True);
           RenameFile(path+'\VBUSERREG.DB',path+'\WardWiz Antivirus\VBUSERREG.DB') ;
          end
        else
     DelTree(path+'\WardWiz Antivirus\*', False, True, True);
end;
