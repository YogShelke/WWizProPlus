...
#define MyAppName "WardWiz Patch"
#define MyAppTitle "WardWiz Patch"
#define MyAppVersion "1.8.3.0"
#define MyUninstallName "WardWiz version 1.8.3.0"
#define MyWelcomeMsg1 "Welcome to the WardWiz Patch Setup Wizard"
;#define MyWelcomeMsg2 "This will install WardWiz Patch version 1.8.2.0 on your computer"
#define MyWelcomeMsg2 "This will install WardWiz Patch on your computer"

#define FinishedHeadingLabelMsg ="Completing the WardWiz Patch Setup Wizard"
#define FinishedLabelMsg ="Setup has finished installing WardWiz Patch on your computer. The application may be launched by selecting the installed icons."
#define ReadyLabel1Msg ="Setup is now ready to begin installing WardWiz Patch on your computer."
#define InstallingLabelMsg ="Please wait while Setup installs WardWiz Patch on your computer."
...
OutputDir=.\Output
OutputBaseFilename=WardWizProPatchIx86
...
DisableDirPage =yes
; lalit 2-4-2015 to keep original installation -uninstallation log path
...
CMWWCloseAllWWApp =Please close all WardWiz running application(s) for reinstallation
english.CMWWCloseAllWWApp =Please close all WardWiz running application(s) for reinstallation
...
CMWWFirstInstallWardWiz =WardWiz not installed.Please first install WardWiz
english.CMWWFirstInstallWardWiz =WardWiz not installed.Please first install WardWiz
german.CMWWFirstInstallWardWiz =WardWiz nicht installed.Please ersten WardWiz installieren

CMWWPatchValidForPro =This patch is applicable to WardWiz Pro only, Please install appropriate patch
english.CMWWPatchValidForPro =This patch is applicable to WardWiz Pro only, Please install appropriate patch
german.CMWWPatchValidForPro =Dieser Patch ist für WardWiz Pro nur, Bitte installieren Sie entsprechende Patch
...
[Messages]
;SetupWindowTitle ={#MyAppTitle}
;WelcomeLabel1    = {#MyWelcomeMsg1}
;WelcomeLabel2    ={#MyWelcomeMsg2}
;FinishedHeadingLabel ={#FinishedHeadingLabelMsg}
;FinishedLabel ={#FinishedLabelMsg}
;ReadyLabel1 ={#ReadyLabel1Msg}
;InstallingLabel ={#InstallingLabelMsg}
;lalit 2-7-2015 offline patches not contain latest dabase it only product binaries
;ClickFinish =Product version: {#AppVer}
...
[Dirs]
Name: {app}\LOG
Name: {commonappdata}\{#MyAppPublisher}; attribs: hidden; Flags: uninsalwaysuninstall; Tasks: 
Name: {app}; Flags: uninsalwaysuninstall; Tasks: ; Languages: 
Name: {app}\QUARANTINE; Tasks: ; Languages: 

[Files]
Source: RequiredFiles\PROTECTION\32\{#FPSCANNER}; DestDir: {app}\DRIVERS; Flags: ignoreversion
Source: RequiredFiles\PROTECTION\32\{#PPSECURE64}; DestDir: {app}\DRIVERS; Flags: ignoreversion
Source: RequiredFiles\PROTECTION\32\{#PPXPROC}; DestDir: {app}\DRIVERS; Flags: ignoreversion

Source: RequiredFiles\CPPRESTRIBUTABLES\{#REDESTRIBUTABLES}; Flags: dontcopy nocompression overwritereadonly
...
Source: ..\Release\Win32\Binaries\WRDWIZUI.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZALUSRV.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZUSBDETECTUI.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZCOMMSRV.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZTRAY.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZSETUPDLL.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZUSBDETECT.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZSCANDLL.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZINDEX.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZREPAIRDLL.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZREGISTRATION.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\Win32\Binaries\WRDWIZREGISTERDATA.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZRKSCN.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZRESOURCE.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\Win32\Binaries\WRDWIZCLOSEALL.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\Win32\Binaries\WRDWIZHASH.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\Win32\Binaries\WRDWIZEXTRACT.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
...
Source: ..\Release\Win32\Binaries\WRDWIZSHELLEXT.DLL; DestDir: {app}; Flags: ignoreversion regserver 32bit noregerror  overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZUNINST.EXE; DestDir: {app}; Flags: ignoreversion
Source: ..\Release\Win32\Binaries\WRDWIZHEUSCN.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZAUTORUNSCN.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZTEMPCLR.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZUSBVAC.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZUTILITY.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZCRYPT.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\Win32\Binaries\WRDWIZEMAILADDIN.DLL; DestDir: {app}; Flags: ignoreversion regserver 32bit overwritereadonly sharedfile noregerror
Source: ..\Release\Win32\Binaries\WRDWIZOFFLINEREG.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZBOOTSCN.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZUPDATE.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZRESCUEDISK.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: SETTINGS\PROPRDSETTING\PRODUCTSETTINGS.INI; DestDir: {app}\WRDSETTINGS; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
Source: SETTINGS\ESSENTIALPLUSSETTING\WWF.INI; DestDir: {app}\WRDSETTINGS; Flags: ignoreversion overwritereadonly onlyifdoesntexist
...
Source: Logo\COMPANYLOGO.ICO; DestDir: {app}; Flags: ignoreversion
Source: RequiredFiles\EVALREGDLLS\x86\WRDWIZEVALREG.DLL; DestDir: {app}; Flags: ignoreversion onlyifdoesntexist overwritereadonly
...
;Source: RequiredFiles\EMAILSCAN\WRDWIZSIGNATUREEMAIL.DB; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\EMAILSCAN\WRDWIZMALICIOUSSITES.DB; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\UNRAR\x86\UNRAR.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\LIBCLAMAV.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\WRDWIZSCANNER.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\WRDWIZHELP\WRDWIZPRO\WRDWIZPRO.CHM; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\WRDWIZHELP\WRDWIZPRO\WRDWIZPROGERMAN.CHM; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: RequiredFiles\DB\*; DestDir: {app}\DB; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
;Source: RequiredFiles\WRDWIZDATABASE\*; DestDir: {app}\WRDWIZDATABASE; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
;Source: RequiredFiles\MICROSOFT.VC80.CRT\*; DestDir: {app}\MICROSOFT.VC80.CRT; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: RequiredFiles\WRDWIZSECURITYNEWS\WRDWIZSECURITYNEWS.TXT; DestDir: {app}; Flags: ignoreversion overwritereadonly recursesubdirs createallsubdirs 32bit
Source: ..\Release\Win32\Binaries\WRDWIZMD5SCN.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
;Source: ..\Release\x64\Binaries\WRDWIZMD5SCN32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\SCITERDLL\32\SCITER32.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\SQLITE\32\SQLITE3.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\SQLITE\32\TISCRIPT-SQLITE.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: ..\Release\Win32\Binaries\WRDWIZPOLYSCN.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\BDS\Win32\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs  overwritereadonly
Source: RequiredFiles\BDSENGINEFILES\Win32\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs overwritereadonly
Source: RequiredFiles\TPDLLS\Win32\7-ZIP.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly regserver
Source: RequiredFiles\TPDLLS\Win32\7Z.DLL; DestDir: {app}; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\TPAPPS\Win32\7Z.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly 
Source: RequiredFiles\SETUPDB\RLOC.DB; DestDir: {app}; Flags: ignoreversion overwritereadonly       
Source: RequiredFiles\TPAPPS\Win32\WWIZRMTAST.EXE; DestDir: {app}; Flags: ignoreversion overwritereadonly                 
...
[Run]
;Filename: {app}\{#MyAppExeName}; Description: {cm:LaunchProgram,{#StringChange(MyAppPublisher, '&', '&&')}}; Flags: nowait postinstall skipifsilent runascurrentuser
;lalit 2-4-2015 to update product version to control panel even uninstallation log disable
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: string; ValueName: SupportNo; ValueData: {code:GetSupportNo| SupportNo}; Flags: uninsdeletekey
...
function GetdwRelNotesShow(Value_Name : string): string;
 ...
 begin
      RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwRelNotesShow', Value_Data);
...
function GetdwIsOffline(Value_Name : string): string;
         ...
         var temp_data : string;
 begin
      RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwIsOffline', Value_Data);
      temp_data := IntToStr(Value_Data);
...
function GetdwLocID(Value_Name : string): string;
         ...
         var Locid : string;
 begin
      RegQueryDWordValue(HKEY_LOCAL_MACHINE ,'SOFTWARE\Wardwiz Antivirus', 'dwLocID', Value_Data);
...
// lalit 2-10-2015 If install 1.0.0.8 and then installed againg latest setup then
//start menu show dublicate uninstaller icon "uninstall wardwiz antivirs and uninstall wardwiz"
procedure RemPreviousQuickLunchIcon();
var
  RegKey: string;
  RegValue: string;
...
begin
    ...
    begin
		...
		// c++ REDESTRIBUTABLES is required in patches  ,add by lalit 4-29-2015
      ResultCode := GetOSVersion();
		if(ResultCode = 5 ) then
		begin
    ...
    begin
      //Adding a support no according to country. neha Gharge 15 sept,2015
      //AddSupportNo();
...
begin
     ...
     // RegisterSetupWithDrivers() ; // register with drivers
...
//       StartDriverServiceLocal();
//       RegisterSetupWithDrivers();
       //setup registration if driver working.
       PauseProtectionDrivers();
...
begin
   ...
   RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{078ABE62-583D-43e6-96D6-5D092883DC82}_is1',
    'DisplayName', '"WardWiz Antivirus version" {#AppVer}');

   RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{078ABE62-583D-43e6-96D6-5D092883DC82}_is1',
    'QuietUninstallString', '"C:\Program Files\WardWiz Antivirus\WRDWIZUNINST.exe" /SILENT');

   RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{078ABE62-583D-43e6-96D6-5D092883DC82}_is1',
    'UninstallString', '"C:\Program Files\WardWiz Antivirus\WRDWIZUNINST.exe"');
...
begin
  ...
  if (CurPage = 1) then
   ...
   begin
    ...
    RegKey := Format('%s', ['SOFTWARE\Wardwiz Antivirus']);
    RegKey := ExpandConstant(RegKey);
    if RegKeyExists(HKEY_LOCAL_MACHINE,RegKey)=False then
    begin
        MsgBox(ExpandConstant('{cm:CMWWFirstInstallWardWiz}'), mbError, MB_OK)  ;
        ExitProcess(0);

    end;


    RegQueryDWordValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Wardwiz Antivirus','dwProductID', ProductID);    //RegQueryDWordValue
    if not ( ProductID = 2) then
    begin
      MsgBox(ExpandConstant('{cm:CMWWPatchValidForPro}'), mbError, MB_OK);
      ExitProcess(0);
    end;

	Result := CheckForPreviousVersion('PRO',CurrentVersion,true);
 ...
 // resolved by lalit kumawat 8-31-2015
  ...
  begin
   //  StartStartUpApplications(ExpandConstant('{pf}\WardWiz Antivirus\'))
...
// resolved by lalit kumawat, issue - if i applyied offline patch and uninstall setup in such case it does not asking about quarntine folder"want to keep quarntine or not".
...
case CurUninstallStep of
  usPostUninstall:
     ...
     usDone: // lalit 2-3-2015 in silent mode successful uninstallation messge
      begin
	   // lalit 2-9-2015  issue- in vista ontrol panel showing entry even product uninstalled
         ...
         begin
            if( MsgBox( ExpandConstant('{cm:CMWWRestartReq}') , mbConfirmation, MB_YESNO) = IDYES ) then
              begin
               ...
               MoveFileEXtoRestartDlt(ExpandConstant('{pf}\WardWiz Antivirus\'))  ;
              RestartNow();
              end;
         end
         end;
...
begin
  ...
  SetApplicationPath(ExpandConstant('{pf}\WardWiz Antivirus\'));
...
// lalit 2-3-2015 in silent mode custom confirmation message box handling
...
begin
 ...
 if  Result then
  ...
  if Result then
        begin
            ResultOfCloseAll := CloseAllApplicationForUninstall(ExpandConstant('{pf}\WardWiz Antivirus\'));
