...
OutputDir=.\Output
OutputBaseFilename=WardWizProSetupNCIx64
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: ScanType; ValueData: {code:GetScanType| -1}; Flags: uninsdeletekey
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwIsOffline; ValueData: {code:GetdwIsOffline| 1}; Flags: uninsdeletekey
...
begin
  ...
  // check for lower version of windows XP SP3 and server
