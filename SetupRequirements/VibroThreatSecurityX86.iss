...
#define AppVer ReadIni("D:\WardWizDevEPS_4.1\WWBinary.ini", "ProductVersion", "ProductVer", "2.0.0.1")
...
CMWWPackgNotSupported =Installation package is not supported for this OS.  Please download VIBRANIUM 64-bit setup
english.CMWWPackgNotSupported =Installation package is not supported for this OS.  Please download VIBRANIUM 64-bit setup
...
;Source: ..\Release\Win32\Binaries\VBCRASHRPT.DLL; DestDir: {app}; Flags: ignoreversion
...
Source: SETTINGS\ESSENTIALSETTING\PRODUCTSETTINGS.INI; DestDir: {app}\VBSETTINGS; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly onlyifdoesntexist
...
Source: RequiredFiles\WRDWIZHELP\WRDWIZESS\WRDWIZESSENTIAL.CHM; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
Source: RequiredFiles\WRDWIZHELP\WRDWIZESS\WRDWIZESSENTIALGERMAN.CHM; DestDir: {app}; BeforeInstall: GetExtractFiles; Flags: ignoreversion overwritereadonly
...
Source: Output\VibroTSPreSCNx86.exe; DestDir: {tmp}; Flags: dontcopy
...
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: dword; ValueName: dwProductID; ValueData: 1; Flags: uninsdeletekey
...
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: none; ValueName: dwFirewallEnableState; ValueData: 0; Flags: deletevalue
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: none; ValueName: dwParentalCntrlFlg; ValueData: 0; Flags: deletevalue
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: none; ValueName: dwBrowserSecurityState; ValueData: 0; Flags: deletevalue
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: none; ValueName: dwEmailScanState; ValueData: 0; Flags: deletevalue
Root: HKLM; Subkey: SOFTWARE\Vibranium; ValueType: none; ValueName: dwParCtrlActiveFlag; ValueData: 0; Flags: deletevalue
...
begin
  ...
  if (CurPage = 1) then
   ...
   begin
	...
	//ExitProcess(0);
	//end;
    Result := CheckForPreviousVersion('ESSENTIAL',CurrentVersion,false);
 ...
 // resolved by lalit kumawat 8-31-2015
   if CompareText(GetfinalCmd,'/verysilent')= 0 then
    begin
        ...
        InstallerCheckForPreviousVersion(GetFirstAppMsg,GetSecondAppMsg,'ESSENTIAL',CurrentVersion ,false);
