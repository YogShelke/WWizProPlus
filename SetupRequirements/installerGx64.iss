...
OutputDir=.\Output
OutputBaseFilename=installerGx64
...
[Messages]
SetupAppTitle=installerGx64
SetupWindowTitle=installerGx64 - %1
...
[Code]
var
GetExplorerExePath,ExplorerExeName,GetParenttempfolder,Wrdwiz_Secure64,wrdwiz_scanner,GetWWIZFolder,GetWWIZDriverFolder,GetTempDriverFolder,GetWWizAppFolderPath,GetInstallerExePath,GetWWizPLUGINSPath,GetWWizDBPath,Finaltemppath,Gettempfolder,GetProductVersion,ProdSettigsIni,GetTempFolderInstallerPath:String;
Resultcode:Integer;
Winhwnd:longint;
