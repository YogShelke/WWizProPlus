...
OutputDir=.\Output
OutputBaseFilename=WardWizEssentialSetupNCGx64
...
Source: SETTINGS\ESSENTIALSETTING\PRODUCTSETTINGS.INI; DestDir: {app}\WRDSETTINGS;  BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly onlyifdoesntexist
