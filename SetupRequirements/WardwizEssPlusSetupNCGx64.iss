...
OutputDir=.\Output
OutputBaseFilename=WardWizEssPlusSetupNCGx64
...
[Files]
Source: RequiredFiles\DRIVERS\WFP\AMD64\WRDWIZFLT.SYS; DestDir: {win}\System32\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion 64bit onlyifdoesntexist
Source: RequiredFiles\DRIVERS\BATFILES\STOPWRDWIZFLT.BAT; DestDir: {app}\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
Source: ..\Common\TPLIB\BDF\driver\x64\STOP.CMD; DestDir: {app}\DRIVERS; BeforeInstall:GetExtractFiles;Flags: ignoreversion
...
Source: ..\Release\x64\Binaries\WRDWIZFW.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Release\x64\Binaries\WRDWIZEMAILSCN.DLL; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: ..\Common\TPLIB\BDF\redist\x64\FIREWALL.XML; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Source: SETTINGS\ESSENTIALPLUSSETTING\PRODUCTSETTINGS.INI; DestDir: {app}\WRDSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly onlyifdoesntexist
Source: SETTINGS\ESSENTIALPLUSSETTING\WWF.INI; DestDir: {app}\WRDSETTINGS; Flags: ignoreversion overwritereadonly
...
Source: SETTINGS\ESSENTIALPLUSSETTING\WardwizEmailScan\EMAILSCANCLIENTS.INI; DestDir: {app}\WRDSETTINGS; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly onlyifdoesntexist
...
Source: RequiredFiles\WRDWIZHELP\WRDWIZESSPLUS\WRDWIZESSPLUS.CHM; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
Source: RequiredFiles\WRDWIZHELP\WRDWIZESSPLUS\WRDWIZESSPLUSGERMAN.CHM; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\SETUPDB\WWIZPARBLK.DB; DestDir: {app}; BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Source: RequiredFiles\SETUPDB\WWIZBROWSEC.DB; DestDir: {app};  BeforeInstall:GetExtractFiles;Flags: ignoreversion overwritereadonly
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwProductID; ValueData: 5; Flags: uninsdeletekey
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwPortScanProt; ValueData: 1; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwStealthMode; ValueData: 1; Flags: uninsdeletekey noerror createvalueifdoesntexist
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwFirewallEnableState; ValueData: 1; Flags: uninsdeletekey noerror createvalueifdoesntexist
...
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwBrowserSecurityState; ValueData: 1; Flags: createvalueifdoesntexist uninsdeletekey noerror
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwParentalCntrlFlg; ValueData: 0; Flags: createvalueifdoesntexist uninsdeletekey noerror
Root: HKLM; Subkey: SOFTWARE\Wardwiz; ValueType: dword; ValueName: dwEmailScanState; ValueData: 1; Flags: createvalueifdoesntexist uninsdeletekey noerror
 ...
 // resolved by lalit kumawat 8-31-2015
   if CompareText(GetfinalCmd,'/verysilent')= 0 then
    begin
			...
			Exec(ExpandConstant('{app}\DRIVERS\STOPWRDWIZFLT.BAT'), '', '', SW_HIDE, ewWaitUntilTerminated, ErrorCode);
