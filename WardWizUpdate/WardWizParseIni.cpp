/**********************************************************************************************************
Program Name          : WardWizParseIniFile.CPP
...
*  Modified Date  :	14-Jul -2014 to 22-jul-2014(Neha Gharge)
****************************************************************************************************/
bool WardWizParseIniFile::ParseDownloadedPatch_Ini(LPTSTR lpszIniPath, DWORD dwProductID, bool bProductUpdate, bool &bRetIsAnyProductChanges, bool bIsWow64)
{
	bool	bRet = true;
	TCHAR	szCount[256] = {0};
...
bool WardWizParseIniFile::CheckFilePresentIsLatest( PALUFILEINFO pALUFileInfo)
{
	...
	{
		AddLogEntry(L">>> Exception in VibraniumParseIniFile::CheckFilePresentIsLatest", 0, 0, true, FIRSTLEVEL);
	}
