...
bool CWWizProdDownloader::StartDownloadFile(LPCTSTR szUrlPath, LPTSTR lpszTargetPath)
{
	...
	{
		AddLogEntry(L"### Exception in CGenXProdDownloader::StartDownloadFile", 0, 0, true, SECONDLEVEL);
		return false;
	}
	return true;
}
...
bool CWWizProdDownloader::RunSetupInSilentMode(LPCTSTR szSetupPath)
{
	...
	{
		AddLogEntry(L"Exception in GenXAluSrv::RunUtililtyInSilentMode", 0, 0, true, SECONDLEVEL);
		return false;
	}
	return false;
}