/****************************** Module Header ******************************\
* Module Name:  WardwizServiceHandler.cpp
...
#define SERVICE_NAME             L"WardwizClientAgent"

// Displayed name of the service
#define SERVICE_DISPLAY_NAME     L"WardwizClientAgent" 
...
int wmain(int argc, wchar_t *argv[])
{
    ...
    else
    {
        ...
        CWardwizClientAgent service(SERVICE_NAME);
