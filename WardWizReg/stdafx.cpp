...
// WardWizRegistration.pch will be the pre-compiled header
// stdafx.obj will contain the pre-compiled type information

#include "stdafx.h"
#define LOG_FILE					_T("VIBOUI.LOG")
...
bool GetModulePath(TCHAR *szModulePath, DWORD dwSize)
{
	...
	_tcscpy(szModulePath, csProductFolderPath);
	return true;
}
				 ...
				 bool isDateTime, DWORD dwLogLevel)
{
	try
	{
		...
		{
			csScanLogFullPath = GetWardWizPathFromRegistry() + L"Log";
