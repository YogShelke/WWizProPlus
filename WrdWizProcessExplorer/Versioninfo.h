...
public:
	...
	LPCTSTR AsString(wstring& str) const;
	// The "Short" methods only returns major and minor nums.
	LPCTSTR AsStringShort(wstring& str) const;
	...
	//For extended info
	LPCTSTR GetExtProductName(wstring*) const;
...
private:
	...
	wstring m_strFileVersion;
	wstring m_strProductName;
	wstring m_strCompany;
