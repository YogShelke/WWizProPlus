...
void CVersionInfo::SetFromVerInfo(const CVersionInfo& ver)
{
	...
	m_strDescription = ver.m_strDescription;
	m_strFileVersion = ver.m_strFileVersion;
}
...
LPCTSTR CVersionInfo::AsString(wstring& str) const
{
...
LPCTSTR CVersionInfo::AsStringShort(wstring& str) const
{
	TCHAR tszVer[CBVERSTR];
...
LPCTSTR CVersionInfo::GetExtProductName(wstring* pstr) const
{
	wstring str;
...
LPCTSTR CVersionInfo::GetFileVersion() const
{
	return m_strFileVersion.data();
}

LPCTSTR CVersionInfo::GetDescription() const
{
	return m_strDescription.data();
}
