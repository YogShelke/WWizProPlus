...
class CWardWizQuickScan : sciter::event_handler,
...
public:
	...
	BEGIN_FUNCTION_MAP
		FUNCTION_4("OnStartQuickScan", On_StartQuickScan)
		FUNCTION_1("OnPauseQuickScan", On_PauseQuickScan)
		FUNCTION_1("OnResumeQuickScan", On_ResumeQuickScan)
		FUNCTION_1("OnStopQuickScan", On_StopQuickScan)
		FUNCTION_1("OnClickShutDwonScan", On_ClickShutDwonScan)
		FUNCTION_0("CallContinueQuickScan", On_CallContinueQuickScan)
		FUNCTION_0("OnSetTimer", OnSetTimer)
		FUNCTION_1("ScanFinishedCall", On_ScanFinishedCall)
		FUNCTION_1("GetQuickScanStatus", GetQuickScanStatus)
	END_FUNCTION_MAP

	json::value GetQuickScanStatus(SCITER_VALUE svIsScanRunning);
	json::value On_ScanFinishedCall(SCITER_VALUE svGetScanFinishedFlag);
	json::value On_StartQuickScan(SCITER_VALUE svStatusFunctionCB, SCITER_VALUE svFunAddVirusFoundEntryCB, SCITER_VALUE svFunSetScanFinishedStatusCB, SCITER_VALUE svFunNotificationMessageCB);
	...
	json::value On_StopQuickScan(SCITER_VALUE svbIsManualStop);
	json::value On_ClickShutDwonScan(SCITER_VALUE svIsShutDownPC);
	json::value On_CallContinueQuickScan();
